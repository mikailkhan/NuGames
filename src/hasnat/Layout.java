...
public class Layout {
    ...
    public void draw(Graphics2D g){
        ...
        g.drawString("RED_K", 90, 35);
        g.drawString("GREEN_S", 370, 35);
        g.drawString("BLUE_N", 90, 540);
        g.drawString("YELLOW_H", 370, 540);
        g.drawString("Instruction:", 550,300);
        g.drawString("1.Click Enter to roll the Dice", 550,350);
        g.drawString("2.Click on players's coin to Move.", 550,400);
    }
}
